...
//				}
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int drawDataPos = drawnSelectedPos - mHalfVisibleItemCount - 1;
            ...
            if (mDataFormat != null) {
	            canvas.drawText(mDataFormat.format(data), mFirstItemDrawX + textOffsetX, itemDrawY, mPaint);
            } else {
	            canvas.drawText(data.toString(), mFirstItemDrawX + textOffsetX, itemDrawY, mPaint);
            }
		}
